...
const firebaseConfig = {
  ...
  authDomain: import.meta.env.STORYBOOK_FIREBASE_AUTH_DOMAIN,
  projectId: import.meta.env.STORYBOOK_FIREBASE_PROJECT_ID,
  storageBucket: import.meta.env.STORYBOOK_FIREBASE_STORAGE_BUCKET,
